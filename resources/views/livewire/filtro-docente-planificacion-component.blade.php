<div class="p-6">
    ...
    <div class="bg-gray-100 px-3 py-3 rounded-lg">
            ...
            <table class="table-tail">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($planificaciones as $item)
                            <tr>
                                <td class="pl-4">
                                    <div class="text-xs font-bold text-gray-900">{{ $item->codigo }}</div>
                                ...
                                <td class="table-tail-td px-2">
                                    <div class="text-sm text-gray-900">{{ Str::title($item->docente->nombre_completo) }}</div>
                                </td>
                                <td class="table-tail-td">
