                        ...
                        @foreach ($carrera->modulos as $modulo)
                            <div class="w-full py-2">
                                <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                                    <div class="bg-cover bg-center h-40" style="background-image: url({{Storage::url('moduloPortadas/' . $modulo->portada)}})">
                                    </div>
                                    <div class="py-2 px-4 h-28">
                                        ...
                                        <p class="text-sm text-gray-900">Carga horaria: {{$modulo->cargaHoraria}} horas académicas</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <section class="col-span-3">
                    <div class="bg-white rounded shadow-md p-4">
                        @if ($carrera->planificacionCarrera)
                            @php
                                $docente = $carrera->planificacionCarrera[0]->docente;
                            @endphp
