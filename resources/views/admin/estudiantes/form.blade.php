<h1 class="text-gray-500 uppercase text-2xl mt-5 text-center">Registro Nuevo Estudiante</h1>
    <div class="w-full">
        <div class="overflow-hidden bg-white sm:rounded-lg px-5 py-2">
            ...
            <div class="mt-4">
                <div class="flex items-center">
                    ...
                    <div class="mr-3">
                        ...
                        <x-jet-input id="complemento" type="text" wire:model.defer="complemento"
                            class="mt-1 block w-full"/>
                        <x-jet-input-error for="complemento" class="mt-2" />
                    </div>
                    <div class="flex-1">
                        <x-required-label for="expedido" value="Expedido"></x-required-label>
                        <select wire:model.defer="expedido" id="expedido" class="custom-select sm:text-sm">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="email" type="email" wire:model.defer="email" class="mt-1 block w-full" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3 mt-4">
                <div>
                    ...
                    <x-jet-input id="nombreFamiliar" type="text" wire:model.defer="nombreFamiliar" class="mt-1 block w-full codigo" />
                    <x-jet-input-error for="nombreFamiliar" class="mt-2" />
                </div>
                <div>
                    <x-required-label for="paternoFamiliar" value="Paterno" />
                    <x-jet-input id="paternoFamiliar" type="text" wire:model.defer="paternoFamiliar" class="mt-1 block w-full codigo" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-3 mt-4">
                <div>
                    ...
                    <x-jet-input id="maternoFamiliar" type="text" wire:model.defer="maternoFamiliar" class="mt-1 block w-full codigo" />
                    <x-jet-input-error for="maternoFamiliar" class="mt-2" />
                </div>
                <div class="flex-1 mr-3">
                    <x-required-label for="celularFamiliar" value="Celular" />
                    <x-jet-input id="celularFamiliar" type="number" wire:model.defer="celularFamiliar" class="mt-1 block w-full" />
            ...
            <div class="mt-4">
                <div class="flex items-center">
                    <div class="flex-1 mr-3">
                        ...
                        <select wire:model.defer="grado" id="grado" class="custom-select sm:text-sm">
                    ...
                    <div class="flex-1">
                        ...
                        <x-jet-input id="carrera" wire:model.defer="carrera" type="text" class="block w-full"/>
            ...
            <div class="mt-4">
                <div class="flex items-center">
                    <div class="flex-1 sm:flex-auto mr-3">
                        ...
                        <x-jet-input id="profesion" type="text" wire:model.defer="profesion" class="block w-full"/>
                    ...
                    <div class="flex-1 sm:flex-auto">
                        ...
                        <x-jet-input id="universidad" type="text" wire:model.defer="universidad" class="block w-full"/>
