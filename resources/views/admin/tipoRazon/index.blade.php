            ...
            registro.addEventListener('change', (e) => {
                ...
                if(e.target.checked){
                    ...
                    window.livewire.on('exist', value => {
                        if(value == 1){
                            Swal.fire({
                                title: '¿Estas seguro de deshabilitar este registro? Porque ya tiene registros económicos realizados',
                                type: 'warning',
                                ...
                                if(result.dismiss === "cancel" || result.dismiss === "backdrop") {
                                    ...
                                    Livewire.emitTo('tipo-razon-component','deshabilitarRegistro',id);
                                    return;
                                }
                            });
                        }else{
                    ...
                    Livewire.emitTo('tipo-razon-component','habilitarRegistro',id);
                    return;
                }
            });
        });
