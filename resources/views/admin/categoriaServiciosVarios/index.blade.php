    ...
    <div class="py-2">
        <div class="w-full">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                @livewire('categoria-servicio-component')
            </div>
        </div>
    </div>
@stop
            ...
            registro.addEventListener('change', (e) => {
                ...
                if(e.target.checked){
                    ...
                    window.livewire.on('exist', value => {
                        if(value == 1){
                            Swal.fire({
                                title: '¿Estas seguro de deshabilitar este registro? Porque ya tiene servicios asignados',
                                type: 'warning',
                                ...
                                if(result.dismiss === "cancel" || result.dismiss === "backdrop") {
                                    ...
                                    Livewire.emitTo('categoria-servicio-component','deshabilitarRegistro',id);
                                    return;
                                }
                            });
                        }else{
                    ...
                    Livewire.emitTo('categoria-servicio-component','habilitarRegistro',id);
                    return;
                }
            });
        });
